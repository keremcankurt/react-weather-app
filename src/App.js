...
const App = () => {
  ...
  return (
    <div className="bg-gradient-to-br from-blue-500 to-blue-300 h-screen flex flex-col items-center justify-center gap-5">
      <div className="bg-white w-96 p-4 rounded-md">
        ...
        <div
          className={`bg-white w-96 rounded-md flex items-center justify-center duration-300 delay-75  overflow-hidden
